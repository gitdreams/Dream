...
![分组查询](D:\LZHROOT\大数据资料\学习笔记\SQL\分组查询.png)
...
![SQL执行顺序图](D:\LZHROOT\大数据资料\学习笔记\SQL\SQL执行顺序.jpg)
...
![左外连接](D:\LZHROOT\大数据资料\学习笔记\SQL\左外连接.png)



![右外连接](D:\LZHROOT\大数据资料\学习笔记\SQL\右外连接.png)
...
![全外连接](D:\LZHROOT\大数据资料\学习笔记\SQL\全外连接.png)
